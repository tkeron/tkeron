export const writeLogElement = (
  message: string,
  document: Document,
  type: "tkeron_log" | "tkeron_error" = "tkeron_log",
) => {
  let tkeronBackLogs =
    document.body.querySelector(".tkeron_back_logs") ||
  ...
  if (!document.body.querySelector(".tkeron_back_logs")) {
    ...
    if (document.body) document.body.appendChild(tkeronBackLogs);
      ...
      document.addEventListener("load", () =>
        document.body.appendChild(tkeronBackLogs),
      );
  }
