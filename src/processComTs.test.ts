...
`;
  ...
  describe("Component substitution in <head>", () => {
    it("should replace custom elements in <head> section", async () => {
      const { dir: TEST_DIR } = getTestResources("processComTs-should-replace-components-in-head");
...
<meta property="og:title" content="Test Title">\`;`;
    ...
    it("should replace custom elements in both <head> and <body>", async () => {
      const { dir: TEST_DIR } = getTestResources("processComTs-should-replace-in-head-and-body");
